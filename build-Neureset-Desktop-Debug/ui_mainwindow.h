...
public:
    ...
    QToolButton *showWaveformButton;
    QMenuBar *menubar;
    QMenu *menuNeureset;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        okButton->setGeometry(QRect(510, 140, 30, 30));
        QFont font3;
        ...
        batterySlider->setTickInterval(20);
        ...
        showWaveformButton = new QToolButton(panelFrame);
        showWaveformButton->setObjectName(QString::fromUtf8("showWaveformButton"));
        showWaveformButton->setGeometry(QRect(10, 300, 161, 24));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        showWaveformButton->setText(QCoreApplication::translate("MainWindow", "Show Waveform", nullptr));

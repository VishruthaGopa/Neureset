...
#include <memory>
#include "../../Testing2/neuresetdevice.h"
...
QT_MOC_LITERAL(1, 15, 15), // "sessionProgress"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 10), // "percentage"
QT_MOC_LITERAL(4, 43, 22), // "treatmentAppliedSignal"
QT_MOC_LITERAL(5, 66, 17) // "pauseTimerElapsed"

    },
    "NeuresetDevice\0sessionProgress\0\0"
    "percentage\0treatmentAppliedSignal\0"
    "pauseTimerElapsed"
};
...
void NeuresetDevice::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sessionProgress((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->treatmentAppliedSignal(); break;
        case 2: _t->pauseTimerElapsed(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (NeuresetDevice::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NeuresetDevice::sessionProgress)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NeuresetDevice::treatmentAppliedSignal)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (NeuresetDevice::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NeuresetDevice::pauseTimerElapsed)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void NeuresetDevice::sessionProgress(int _t1)
{
...
// SIGNAL 1
void NeuresetDevice::treatmentAppliedSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void NeuresetDevice::pauseTimerElapsed()
{

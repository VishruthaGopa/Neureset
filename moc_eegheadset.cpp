...
QT_MOC_LITERAL(5, 40, 22) // "handleTreatmentApplied"

    },
    "EEGHeadset\0newSession\0\0Session*\0session\0"
    "handleTreatmentApplied"
};
...
void EEGHeadset::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->newSession((*reinterpret_cast< Session*(*)>(_a[1]))); break;
        case 1: _t->handleTreatmentApplied((*reinterpret_cast< Session*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (EEGHeadset::*)(Session * );
...
// SIGNAL 0
void EEGHeadset::newSession(Session * _t1)
{
